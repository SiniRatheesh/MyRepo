    ...
    return els.each(function(i) {
      if (this.complete || this.readyState === 'complete') {
        ...
        (function(el) {
          ...
          setTimeout(function() { fn(el) 
        	  console.log('hai : image height : ' + el.clientHeight + ' w : ' + el.clientWidth); 
          		$(window.document).trigger("ComicLoaded",{h:el.clientHeight , w:el.clientWidth});
          }, 1);
        })(this);
      } else {
